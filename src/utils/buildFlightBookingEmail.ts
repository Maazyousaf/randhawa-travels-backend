export const buildFlightBookingEmail = (booking: any): string => {
  ...
  const pricingRows = [
    ...
    Number(booking.extrasTotal) > 0
      ? `<tr>
           <td style="padding:7px 14px;color:#6b7280;font-size:13px;">Extras</td>
           <td style="padding:7px 14px;text-align:right;font-size:13px;">${fmt(booking.extrasTotal)}</td>
         </tr>`
      : "",
  ...
  return `
    <div style="padding:18px 20px;">
      ...
      <div style="text-align:center;margin-bottom:8px;">
        ...
        <p style="margin:0;font-size:14px;color:#6b7280;">Your flight booking request has been received. Our team will review it and contact you shortly for confirmation.</p>
      </div>
      ...
      <table style="width:100%;border-collapse:collapse;margin-bottom:20px;">
        ...
        <tr>
          <td style="padding:6px 0;font-size:13px;color:#6b7280;">Class / Cabin</td>
          <td style="padding:6px 0;font-size:13px;font-weight:500;">${flightClass} — ${cabin}</td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="padding:6px 0;font-size:13px;color:#6b7280;">Stops</td>
          <td style="padding:6px 0;font-size:13px;font-weight:500;">${stopsText}</td>
        </tr>
      </table>
      ...
      <div style="background:#fef3c7;border:2px solid #f59e0b;border-radius:8px;padding:14px 16px;margin-bottom:8px;">
        ...
        <div style="font-size:12px;color:#78350f;line-height:1.65;">
          This is a computer-generated flight booking <strong>request summary</strong> only. 
          It is <strong>not a confirmed airline ticket</strong> and is not valid for check-in, boarding, airport travel, or airline ticket verification.
...
export default buildFlightBookingEmail;
